...
(
	...
	select
		...
		lower(replace(replace(
				...
				'(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=$host_name)(PORT=1526))(CONNECT_DATA=(SERVICE_NAME=$instance_name))) ',
	...
	(
		...
		where instance.target_type in ('oracle_database','pluggable_database')
          and instance.host_name in ('dlph-hyoql01','agii-orasl01','agii-oratrnl01','tab-oradl01')
